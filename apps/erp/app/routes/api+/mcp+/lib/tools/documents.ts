...
export const registerDocumentsTools: RegisterTools = (server, ctx) => {
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await deleteDocumentFavorite(
        ctx.client,
        params.id,
        ctx.userId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await deleteDocumentLabel(
        ctx.client,
        params.id,
        params.label
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getDocuments(ctx.client, ctx.companyId, {
        ...params.args,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await insertDocumentFavorite(
        ctx.client,
        params.id,
        ctx.userId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await insertDocumentLabel(
        ctx.client,
        params.id,
        params.label,
        ctx.userId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertDocument(ctx.client, {
        ...params.document,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateDocumentFavorite(ctx.client, {
        ...params.args,
        userId: ctx.userId
      });
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateDocumentLabels(ctx.client, {
        ...params.document,
        userId: ctx.userId
      });
      return toMcpResult(result);
