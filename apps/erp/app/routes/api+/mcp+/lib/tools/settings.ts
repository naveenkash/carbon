...
export const registerSettingsTools: RegisterTools = (server, ctx) => {
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getAccountsPayableBillingAddress(
        ctx.client,
        ctx.companyId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getAccountsReceivableBillingAddress(
        ctx.client,
        ctx.companyId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateAccountsPayableBillingAddress(
        ctx.client,
        ctx.companyId,
        params.data,
        ctx.userId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateAccountsReceivableBillingAddress(
        ctx.client,
        ctx.companyId,
        params.data,
        ctx.userId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getCurrentSequence(
        ctx.client,
        params.table,
        ctx.companyId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getCustomFieldsTables(
        ctx.client,
        ctx.companyId,
        params.args
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getSequencesList(
        ctx.client,
        params.table,
        ctx.companyId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateCompanyPlan(ctx.client, {
        ...params.data,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateCompany(ctx.client, ctx.companyId, {
        ...params.company,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateKanbanOutputSetting(
        ctx.client,
        ctx.companyId,
        params.kanbanOutput
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateMetricSettings(
        ctx.client,
        ctx.companyId,
        params.useMetric
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertApiKey(ctx.client, {
        ...params.apiKey,
        companyId: ctx.companyId,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateDigitalQuoteSetting(
        ctx.client,
        ctx.companyId,
        params.digitalQuoteEnabled,
        params.digitalQuoteNotificationGroup,
        params.digitalQuoteIncludesPurchaseOrders
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateLogoDark(
        ctx.client,
        ctx.companyId,
        params.logoDark
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateLogoLight(
        ctx.client,
        ctx.companyId,
        params.logoLight
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateLogoDarkIcon(
        ctx.client,
        ctx.companyId,
        params.logoDarkIcon
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateLogoLightIcon(
        ctx.client,
        ctx.companyId,
        params.logoLightIcon
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateMaterialUnitsSetting(
        ctx.client,
        ctx.companyId,
        params.useMetric
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateProductLabelSize(
        ctx.client,
        ctx.companyId,
        params.productLabelSize
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updatePurchasingPdfThumbnails(
        ctx.client,
        ctx.companyId,
        params.includeThumbnailsOnPurchasingPdfs
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateSalesPdfThumbnails(
        ctx.client,
        ctx.companyId,
        params.includeThumbnailsOnSalesPdfs
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateJobTravelerWorkInstructions(
        ctx.client,
        ctx.companyId,
        params.jobTravelerIncludeWorkInstructions
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateTimeCardSetting(
        ctx.client,
        ctx.companyId,
        params.timeCardEnabled
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateConsoleSetting(
        ctx.client,
        ctx.companyId,
        params.consoleEnabled,
        ctx.userId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateRfqReadySetting(
        ctx.client,
        ctx.companyId,
        params.rfqReadyNotificationGroup
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateSuggestionNotificationSetting(
        ctx.client,
        ctx.companyId,
        params.suggestionNotificationGroup
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateMaintenanceDispatchNotificationSettings(
        ctx.client,
        ctx.companyId,
        params.settings
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateSupplierQuoteNotificationSetting(
        ctx.client,
        ctx.companyId,
        params.supplierQuoteNotificationGroup
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updatePurchasePriceUpdateTimingSetting(
        ctx.client,
        ctx.companyId,
        params.purchasePriceUpdateTiming
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateLeadTimesOnReceiptSetting(
        ctx.client,
        ctx.companyId,
        params.updateLeadTimesOnReceipt
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateAccountsPayableAddressSetting(
        ctx.client,
        ctx.companyId,
        params.accountsPayableAddress
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateAccountsReceivableAddressSetting(
        ctx.client,
        ctx.companyId,
        params.accountsReceivableAddress
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateAccountsPayableEmail(
        ctx.client,
        ctx.companyId,
        params.accountsPayableEmail
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateAccountsReceivableEmail(
        ctx.client,
        ctx.companyId,
        params.accountsReceivableEmail
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateDefaultSupplierCc(
        ctx.client,
        ctx.companyId,
        params.defaultSupplierCc
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateDefaultCustomerCc(
        ctx.client,
        ctx.companyId,
        params.defaultCustomerCc
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateQuoteLineCategoryMarkups(
        ctx.client,
        ctx.companyId,
        params.quoteLineCategoryMarkups
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateSequence(
        ...
        params.table,
        ctx.companyId,
        { ...params.sequence, updatedBy: ctx.userId, companyId: ctx.companyId }
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertWebhook(ctx.client, {
        ...params.webhook,
        companyId: ctx.companyId,
        createdBy: ctx.userId
      });
