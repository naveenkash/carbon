...
export const registerInventoryTools: RegisterTools = (server, ctx) => {
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await deleteShipmentLine(
        ctx.client,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await deleteStockTransfer(
        ctx.client,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await deleteStockTransferLine(
        ctx.client,
        params.stockTransferLineId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await deleteWarehouseTransfer(
        ctx.client,
        params.transferId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await deleteWarehouseTransferLine(
        ctx.client,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getItemLedgerPage(
        ctx.client,
        params.itemId,
        ctx.companyId,
        params.locationId,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getBatchProperties(
        ctx.client,
        params.itemIds,
        ctx.companyId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getInventoryItemsCount(
        ctx.client,
        params.locationId,
        ctx.companyId,
        params.args
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getStockTransferLine(
        ctx.client,
        params.stockTransferLineId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getStockTransferLines(
        ctx.client,
        params.stockTransferId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getStockTransferTracking(
        ctx.client,
        params.stockTransferId,
        ctx.companyId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getDefaultShelfOrShelfWithHighestQuantity(
        ctx.client,
        params.itemId,
        params.locationId,
        ctx.companyId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getReceiptTracking(
        ctx.client,
        params.receiptId,
        ctx.companyId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getReceiptLineTracking(
        ctx.client,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getReceiptFiles(
        ctx.client,
        ctx.companyId,
        params.lineIds
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getSerialNumbersForItem(ctx.client, {
        ...params.args,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getBatchNumbersForItem(ctx.client, {
        ...params.args,
        companyId: ctx.companyId
      });
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getShelvesListForLocation(
        ctx.client,
        ctx.companyId,
        params.locationId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getShipmentLinesWithDetails(
        ctx.client,
        params.shipmentId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getShipmentRelatedItems(
        ctx.client,
        params.shipmentId,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getShipmentTracking(
        ctx.client,
        params.shipmentId,
        ctx.companyId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getShipmentLineTracking(
        ctx.client,
        params.shipmentLineId,
        ctx.companyId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getShippingMethod(
        ctx.client,
        params.shippingMethodId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getTrackedEntities(
        ctx.client,
        ctx.companyId,
        params.args
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getTrackedEntitiesByMakeMethodId(
        ctx.client,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getTrackedEntitiesByOperationId(
        ctx.client,
        params.operationId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getWarehouseTransferLine(
        ctx.client,
        params.transferId,
        params.lineId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getWarehouseTransferLines(
        ctx.client,
        params.transferId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await insertManualInventoryAdjustment(ctx.client, {
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateBatchPropertyOrder(ctx.client, {
        ...params.data,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateStockTransferStatus(ctx.client, {
        ...params.args,
        updatedBy: ctx.userId
      });
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertBatchProperty(ctx.client, {
        ...params.batchProperty,
        companyId: ctx.companyId,
        userId: ctx.userId
      });
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertKanban(ctx.client, {
        ...params.kanban,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertReceipt(ctx.client, {
        ...params.receipt,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertShelf(ctx.client, {
        ...params.shelf,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertShippingMethod(ctx.client, {
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertShipment(ctx.client, {
        ...params.shipment,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertStockTransfer(ctx.client, {
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertStockTransferLine(ctx.client, {
        ...params.stockTransferLine,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
      });
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertStockTransferLines(ctx.client, {
        ...params.args,
        companyId: ctx.companyId,
        createdBy: ctx.userId
      });
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertWarehouseTransfer(ctx.client, {
        ...params.transfer,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getDefaultShelfForJob(
        ctx.client,
        params.itemId,
        params.locationId,
        ctx.companyId
