...
export const registerAccountingTools: RegisterTools = (server, ctx) => {
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await deleteAccountSubcategory(
        ctx.client,
        params.accountSubcategoryId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getAccountCategory(
        ctx.client,
        params.accountCategoryId,
        ctx.companyId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getAccountSubcategories(
        ctx.client,
        ctx.companyId,
        params.args
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getAccountSubcategoriesByCategory(
        ctx.client,
        params.accountCategoryId,
        ctx.companyId
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getAccountSubcategory(
        ctx.client,
        params.accountSubcategoryId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getCurrencyByCode(
        ctx.client,
        ctx.companyId,
        params.currencyCode
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getCurrentAccountingPeriod(
        ctx.client,
        ctx.companyId,
        params.date
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getInventoryPostingGroup(
        ctx.client,
        ctx.companyId,
        params.args
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getInventoryPostingGroups(
        ctx.client,
        ctx.companyId,
        params.args
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getPurchasingPostingGroup(
        ctx.client,
        ctx.companyId,
        params.args
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getPurchasingPostingGroups(
        ctx.client,
        ctx.companyId,
        params.args
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getSalesPostingGroups(
        ctx.client,
        ctx.companyId,
        params.args
      );
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateDefaultBalanceSheetAccounts(ctx.client, {
        ...params.defaultAccounts,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateDefaultIncomeAccounts(ctx.client, {
        ...params.defaultAccounts,
        companyId: ctx.companyId,
        updatedBy: ctx.userId
      });
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateFiscalYearSettings(ctx.client, {
        ...params.fiscalYearSettings,
        companyId: ctx.companyId,
        updatedBy: ctx.userId
      });
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertAccount(ctx.client, {
        ...params.account,
        companyId: ctx.companyId,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertAccountCategory(ctx.client, {
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertAccountSubcategory(ctx.client, {
        ...params.accountSubcategory,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
      });
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertCurrency(ctx.client, {
        ...params.currency,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertPaymentTerm(ctx.client, {
        ...params.paymentTerm,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
