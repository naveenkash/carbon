...
export const registerInvoicingTools: RegisterTools = (server, ctx) => {
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await createPurchaseInvoiceFromPurchaseOrder(
        ctx.client,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await createSalesInvoiceFromSalesOrder(
        ctx.client,
        params.salesOrderId,
        ctx.companyId,
        ctx.userId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await createSalesInvoiceFromShipment(
        ctx.client,
        params.shipmentId,
        ctx.companyId,
        ctx.userId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await deletePurchaseInvoiceLine(
        ctx.client,
        params.purchaseInvoiceLineId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await deleteSalesInvoice(
        ctx.client,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await deleteSalesInvoiceLine(
        ctx.client,
        params.salesInvoiceLineId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getPurchaseInvoice(
        ctx.client,
        params.purchaseInvoiceId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getPurchaseInvoiceDelivery(
        ctx.client,
        params.purchaseInvoiceId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getPurchaseInvoiceLines(
        ctx.client,
        params.purchaseInvoiceId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getPurchaseInvoiceLine(
        ctx.client,
        params.purchaseInvoiceLineId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getSalesInvoiceCustomerDetails(
        ctx.client,
        params.salesInvoiceId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getSalesInvoiceShipment(
        ctx.client,
        params.salesInvoiceId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getSalesInvoiceLines(
        ctx.client,
        params.salesInvoiceId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await getSalesInvoiceLine(
        ctx.client,
        params.salesInvoiceLineId
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updatePurchaseInvoiceExchangeRate(
        ctx.client,
        params.data
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updatePurchaseInvoiceStatus(ctx.client, {
        ...params.update,
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateSalesInvoiceExchangeRate(
        ctx.client,
        params.data
      );
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await updateSalesInvoiceStatus(ctx.client, {
        ...params.update,
        updatedBy: ctx.userId
      });
      return toMcpResult(result);
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertPurchaseInvoice(ctx.client, {
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertPurchaseInvoiceDelivery(ctx.client, {
        ...params.purchaseInvoiceDelivery,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
      });
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertPurchaseInvoiceLine(ctx.client, {
        ...params.purchaseInvoiceLine,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
      });
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertSalesInvoice(ctx.client, {
        ...params.salesInvoice,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertSalesInvoiceShipment(ctx.client, {
        ...params.salesInvoiceShipment,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
      });
  ...
  server.registerTool(
    ...
    withErrorHandling(async (params) => {
      const result = await upsertSalesInvoiceLine(ctx.client, {
        ...params.salesInvoiceLine,
        companyId: ctx.companyId,
        createdBy: ctx.userId,
        updatedBy: ctx.userId
      });
